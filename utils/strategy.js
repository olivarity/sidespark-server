...
function Strategy(options, verify) {
  options = options || {};
  options.tokenURL = options.tokenURL || 'https://sidespark.slack.com/api/oauth.access';
  options.authorizationURL = options.authorizationURL || 'https://sidespark.slack.com/oauth/authorize';
